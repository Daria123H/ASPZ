...
[Пишемо код](https://github.com/Daria123H/ASPZ/blob/main/Pr7/PR7_4/PR7_4.c), який виводить вміст одного або кількох файлів, які передано як аргументи командного рядка. Він читає кожен файл пострічково й виводить його на екран по 20 рядків за раз. Після кожних 20 рядків програма зупиняється й чекає, поки користувач натисне Enter, щоб продовжити. Якщо файл не існує або виникає інша помилка при відкритті, на екран виводиться повідомлення про помилку з назвою цього файлу. Якщо жодного файлу не вказано, програма виводить інструкцію щодо правильного використання.

Компілюємо код та запускаємо:

   python3 PR7_4.py PR7_41.txt 
