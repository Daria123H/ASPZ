...
Написала [тестовий випадок](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task3/PR4_3.c), у якому досліджується поведінка malloc(0), яка може варіюватися залежно від реалізації malloc(3) у FreeBSD. malloc(0) може повернути NULL, що означає, що пам'ять не була виділена або повернути ненульовий (не NULL) вказівник, який можна безпечно передати у free(). Код перевіряє, що повертає malloc(0), і відповідно виводить повідомлення. Незалежно від результату, виконується free(ptr), щоб переконатися, що звільнення пам'яті не викликає помилок.

Компілюємо:

![Результат](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task3/PR4_3.png)
...
![Результат](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task3/PR4_33.png)
...
Пишемо програму яка продемонструє помилку, ми виділяємо пам'ять один раз всередині циклу, але після звільнення пам'яті намагаємося знову використовувати той самий вказівник без перевизначення. Кожен виклик free(ptr) викликає звільнення пам'яті. Якщо цикл виконується кілька разів, пам'ять буде звільнена кілька разів. І отримаємо помилку: ![результат](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task4/PR4_4.png)

[Переглянути код](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task4/PR4_4_1.c)

Далі пишемо правильний [код](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task4/PR4_4_2.c). Ми виділяє пам’ять один раз в циклі. Пам’ять звільняється лише після завершення циклу. Якщо пам’ять не вдалося виділити за допомогою malloc, програма виведе повідомлення про помилку.

Результат:

![отримаємо помилку:](https://github.com/Daria123H/ASPZ/blob/main/Pr4/task4/PR4_4_1.png)
