...
Ні, стек не може замінити лічильник команд (IP), тому що процесор повинен знати, яку саме команду виконувати далі. Стек лише зберігає адреси повернення при виклику функцій, але не керує порядком виконання програми. У виводі видно, що gdb показує стек викликів: спочатку була main(), яка викликала function_a(), і адреси повернення збереглися в стеку. Але без IP процесор не зміг би визначити, де саме зараз виконується код.
...
Перш за все я встановила Valgrind.
...
[Пишу код](https://github.com/Daria123H/ASPZ/blob/main/Pr2/task2_21/PR2_21.c). 
...
![Результат](https://github.com/Daria123H/ASPZ/blob/main/Pr2/task2_21/PR2_21.png)
